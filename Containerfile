ARG ADDR_BASE_IMAGE=ghcr.io/geomarker-io/addr:v2.0.0@sha256:97c63d1af61ba45dc0f9a1bbf33eb4c1fc9ded735cd54256386ae55f03c09682
FROM ${ADDR_BASE_IMAGE}

ARG ADDR_BASE_NAME=ghcr.io/geomarker-io/addr:v2.0.0
ARG ADDR_BASE_DIGEST=sha256:97c63d1af61ba45dc0f9a1bbf33eb4c1fc9ded735cd54256386ae55f03c09682
...
ENV ADDR_TAF_SCHEMA=${TAF_SCHEMA} \
    ...
    ADDR_GEOCODE_RELEASE_TAG=${IMAGE_VERSION}
